...
; Копируем все yaml файл из корневой папки приложения в {app}\app
Source: "rr.yaml"; DestDir: "{app}\app"; Flags: 
; Копируем все composer.json файл из корневой папки приложения в {app}\app
Source: "composer.json"; DestDir: "{app}\app"; Flags: 
