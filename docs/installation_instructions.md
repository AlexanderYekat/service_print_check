...
1.  Найдите установочный файл сервиса. Обычно он называется `CloudPosBridge_Installer.exe` или похожим образом.
2.  Дважды щелкните по нему, чтобы запустить установку.

## 2. Процесс установки

1.  **Приветствие:** Вы увидите окно приветствия установщика. Нажмите кнопку **"Далее"**.
2.  **Лицензионное соглашение:** Ознакомьтесь с лицензионным соглашением. Если вы согласны, выберите пункт "Я принимаю условия соглашения" и нажмите **"Далее"**.
3.  **Выбор кассы:** На этом этапе вам будет предложено выбрать тип кассы (старая или новая). Если вы не уверены, какой тип кассы у вас, обратитесь к специалисту или выберите вариант по умолчанию, который предложит установщик. После выбора нажмите **"Далее"**.
4.  **Выбор папки установки:** Рекомендуется оставить путь установки по умолчанию. Нажмите **"Далее"**.
5.  **Готовность к установке:** Убедитесь, что все настройки верны, и нажмите **"Установить"**.
6.  **Завершение установки:** Дождитесь завершения процесса установки. Это может занять несколько минут. После завершения установки нажмите **"Готово"** или **"Завершить"**.
