...
Для маркированных товаров обязательно указывать категорию. Поддерживаемые категории:
...
Подробная информация о категориях товаров доступна в [отдельной документации](category_mapping.md).
  ...
  "tableData": [
    {
      ...
      "taxNDS": "string",    // НДС (необязательно)
      "markingCode": "string", // Маркировочный код (необязательно)
      "category": "string"   // Категория товара (обязательно для маркированных товаров)
    }
  ],
