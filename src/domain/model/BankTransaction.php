 ...
 * 
 * Инкапсулирует бизнес-логику банковской операции:
 * - Может создаваться до выполнения (в "незавершенном" состоянии)
 * - Может обновляться результатом после выполнения
 * - Защищена от неконсистентных состояний
 * - Содержит только доменную логику, без знания об инфраструктуре
 */
