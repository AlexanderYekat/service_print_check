...
//
Функция ПроверитьМаркуНаККТ(КодМарки, ТипОперации = "sell", МаксимумПопыток = 30, ОбработчикРезультата = "") Экспорт    
    // Подготовка данных  
    ...
    Попытка
        Соединение = Новый HTTPСоединение("localhost", 8000, , , , 30);
